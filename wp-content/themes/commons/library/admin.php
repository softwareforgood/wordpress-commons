...
function bones_login_css() {
  ...
  wp_enqueue_style( 'custom_fonts', 'http://fonts.googleapis.com/css?family=Raleway:400,700|Montserrat:400,700', false );
}
...
function bones_custom_admin_footer() {
  _e( '<span id="footer-thankyou">Developed by <a href="http://softwareforgood.com" target="_blank">Software for Good</a></span>.', 'bonestheme' );
}
