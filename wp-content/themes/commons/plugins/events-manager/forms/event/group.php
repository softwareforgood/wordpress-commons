...
if( !is_super_admin() ){
  foreach( $group_data['groups'] as $group_id ){
    ...
    /*
    Limit the list to groups the user is an admin of
...
if( count($user_groups) > 0 ){
  ...
  <br />
  <em><?php _e ( 'To make this a group event, select a group that you are a group leader of.<br />Note that all other admins of that group can modify the booking.', 'dbem' )?></em>
  </p>
