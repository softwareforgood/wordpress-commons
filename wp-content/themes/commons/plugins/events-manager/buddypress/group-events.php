...
/* WARNING! This file may change in the near future as we intend to add features to BuddyPress - 2012-02-14 */
  ...
  <?php // If admin, add a button to create a group event
    //if(bp_group_is_admin()):
    $id = bp_get_group_id();
  ?>
    <p class="alignright"><a class="blue-button" href="<?php echo $url . '?action=edit&id='. $id; ?>"><?php _e('Add Group Event','dbem'); ?></a></p>
  <?php //endif; ?>
