...
<?php if ( have_comments() ) : ?>
  <h3 id="comments" class="h3"><?php comments_number( __( '<span>No</span> Responses', 'bonestheme' ), __( '<span>One</span> Response', 'bonestheme' ), _n( '<span>%</span> Response', '<span>%</span> Responses', get_comments_number(), 'bonestheme' ) );?> to &#8220;<?php the_title(); ?>&#8221;</h3>
...
<section id="respond" class="respond-form">
  ...
  <!-- <p class="comments-logged-in-as"><?php _e( 'Logged in as', 'bonestheme' ); ?> <a href="<?php echo get_option( 'url' ); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo wp_logout_url( get_permalink() ); ?>" title="<?php _e( 'Log out of this account', 'bonestheme' ); ?>"><?php _e( 'Log out', 'bonestheme' ); ?> <?php _e( '&raquo;', 'bonestheme' ); ?></a></p> -->
  ...
  <p style="text-align: right;">
    <input name="submit" type="submit" id="submit" class="button blue-button btn-large" tabindex="5" value="<?php _e( 'Post Comment', 'bonestheme' ); ?>" />
